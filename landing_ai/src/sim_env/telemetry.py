...
class Telemetry:
    ...
    def log(self, entry):
        ...
        self.throttle.append(entry.get('throttle', 0))
    ...
    def save(self):
        ...
        with open(full_path, 'w') as f:
            f.write("step,altitude,aileron,elevator,throttle,pitch,roll\n")
    ...
    def plot(self):
        ...
        axs[1].plot(self.step, self.throttle, color='black', label='Throttle', alpha=0.8)
